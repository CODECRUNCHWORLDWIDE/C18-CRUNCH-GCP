...
- [week 01 gcp resource hierarchy and billing discipline](./curriculum/week-01-gcp-resource-hierarchy-and-billing-discipline/00-overview.md)
- [week 02 iam service accounts and workload identity](./curriculum/week-02-iam-service-accounts-and-workload-identity/00-overview.md)
- [week 03 vpc subnets routes and cloud nat](./curriculum/week-03-vpc-subnets-routes-and-cloud-nat/00-overview.md)
- [week 04 terraform for gcp end to end](./curriculum/week-04-terraform-for-gcp-end-to-end/00-overview.md)
- [week 05 compute engine instance groups and managed vms](./curriculum/week-05-compute-engine-instance-groups-and-managed-vms/00-overview.md)
- [week 06 gke autopilot vs standard](./curriculum/week-06-gke-autopilot-vs-standard/00-overview.md)
- [week 07 cloud run cloud functions and the serverless decision](./curriculum/week-07-cloud-run-cloud-functions-and-the-serverless-decision/00-overview.md)
- [week 08 cloud load balancing and cloud armor](./curriculum/week-08-cloud-load-balancing-and-cloud-armor/00-overview.md)
- [week 09 pubsub and dataflow apache beam](./curriculum/week-09-pubsub-and-dataflow-apache-beam/00-overview.md)
- [week 10 bigquery deep](./curriculum/week-10-bigquery-deep/00-overview.md)
- [week 11 spanner cloud sql alloydb and the database decision](./curriculum/week-11-spanner-cloud-sql-alloydb-and-the-database-decision/00-overview.md)
- [week 12 vertex ai model garden and serving inference](./curriculum/week-12-vertex-ai-model-garden-and-serving-inference/00-overview.md)
- [week 13 observability with opentelemetry](./curriculum/week-13-observability-with-opentelemetry/00-overview.md)
- [week 14 security hardening finops and the on call drill](./curriculum/week-14-security-hardening-finops-and-the-on-call-drill/00-overview.md)
- [week 15 capstone delivery and architecture review](./curriculum/week-15-capstone-delivery-and-architecture-review/00-overview.md)
