...
If you scored under 9, re-read the lectures for the questions you missed — especially the cost-curve math (Q1, Q4) and the `min-instances` break-even (Q6–Q8). If you scored 11 or higher, you're ready for the [homework](./06-homework.md).
