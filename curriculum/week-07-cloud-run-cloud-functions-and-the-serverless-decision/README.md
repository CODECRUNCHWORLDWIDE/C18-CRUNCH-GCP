...
| [resources.md](./resources.md) | Cloud Run v2 docs, the concurrency/CPU tuning guides, Cloud SQL PSC + IAM-auth docs, the Cloud SQL Python connector, Cloud Functions gen2, Eventarc, the pricing pages, and the talks worth your time |
| [lecture-notes/01-the-serverless-cost-curve.md](./lecture-notes/01-the-serverless-cost-curve.md) | The serverless cost curve: where Cloud Run beats GKE and where GKE beats Cloud Run — the model, the 2026 prices, and the crossover request rate |
| [lecture-notes/02-min-instances-one-break-even.md](./lecture-notes/02-min-instances-one-break-even.md) | The "`min-instances=1` pays for itself" threshold and how to compute it — cold-start anatomy, the break-even formula, and a worked spreadsheet |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-tune-concurrency-and-cpu.md](./exercises/exercise-01-tune-concurrency-and-cpu.md) | Deploy a stateless Cloud Run v2 service and tune concurrency and CPU allocation for a target latency |
| [exercises/exercise-02-cloud-run-to-private-cloud-sql-over-psc.py](./exercises/exercise-02-cloud-run-to-private-cloud-sql-over-psc.py) | A FastAPI service that connects to a private Cloud SQL Postgres instance over PSC with IAM auth and no public IP — the app plus the full runbook |
| [exercises/exercise-03-eventarc-gcs-to-cloud-run-job.tf](./exercises/exercise-03-eventarc-gcs-to-cloud-run-job.tf) | Terraform that wires a GCS object-finalize event through Eventarc to a Cloud Run job, with all the IAM |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-coldstart-bakeoff-behind-cloud-armor.md](./challenges/challenge-01-coldstart-bakeoff-behind-cloud-armor.md) | Deploy the service with private Cloud SQL over PSC behind Cloud Armor, benchmark cold-start at min-instances 0/1/3, and produce a monthly-cost comparison |
| [quiz.md](./quiz.md) | 13 questions, answer key at the bottom |
| [homework.md](./homework.md) | Five problems with rubric and time estimates |
| [mini-project/README.md](./mini-project/README.md) | Full spec for the ingest service (Cloud Run + private Cloud SQL over PSC + Eventarc job) that Week 08 fronts, Week 13 instruments, and the capstone reuses |
