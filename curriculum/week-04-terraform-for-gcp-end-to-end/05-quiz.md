...
If you scored under 9, re-read the lecture for the questions you missed — especially the `count`-vs-`for_each` footgun (Q5) and the drift/click-ops discipline (Q11). If you scored 11+, you're ready for the [homework](./06-homework.md) and the mini-project.
