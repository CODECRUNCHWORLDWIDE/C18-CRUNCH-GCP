...
- If you get stuck for more than 15 minutes, read the linked provider docs in [resources.md](../resources.md) — the answer is almost always one required argument you missed (frequently the health-check firewall source ranges).
