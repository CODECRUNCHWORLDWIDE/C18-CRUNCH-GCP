...
When you've finished all six, push your repo and start (or finish) the [mini-project](./07-mini-project/00-overview.md). The homework is the warm-up; the mini-project is the artifact.
