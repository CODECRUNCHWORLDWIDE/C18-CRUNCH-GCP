...
| [resources.md](./resources.md) | The Cloud Load Balancing, Cloud CDN, Cloud Armor, IAP, and PSC docs; the CEL reference; the Terraform LB module; the talks worth your time |
| [lecture-notes/01-the-five-layer-gcp-edge.md](./lecture-notes/01-the-five-layer-gcp-edge.md) | DNS → Cloud Armor → Cloud CDN → LB → backend, layer by layer, with the protection matrix and the LB-selection decision tree |
| [lecture-notes/02-cloud-armor-in-cel.md](./lecture-notes/02-cloud-armor-in-cel.md) | Cloud Armor as a CEL engine: rate limiting, preconfigured WAF rules, bot management, and the rule-ordering rules that make a policy correct |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-global-https-lb-with-cloud-run-neg-and-cdn.md](./exercises/exercise-01-global-https-lb-with-cloud-run-neg-and-cdn.md) | Build a global external HTTPS LB with a Cloud Run serverless NEG backend and attach Cloud CDN, end to end, with verification |
| [exercises/exercise-02-cloud-armor-ratelimit-and-sqli.tf](./exercises/exercise-02-cloud-armor-ratelimit-and-sqli.tf) | Terraform for a Cloud Armor policy with a per-source-IP `rate_based_ban` rule and a preconfigured SQLi WAF rule, plus the `hey` + `curl` validation runbook |
| [exercises/exercise-03-iap-group-gated-internal-app.py](./exercises/exercise-03-iap-group-gated-internal-app.py) | A FastAPI internal app that verifies the IAP-signed JWT, plus the Terraform + `gcloud` to put IAP in front and gate it on a Google group |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-front-week07-with-armor-and-validate-under-load.md](./challenges/challenge-01-front-week07-with-armor-and-validate-under-load.md) | Front the Week 07 Cloud Run service with a global HTTPS LB + CDN + a per-IP rate limit + a SQLi WAF rule, then validate with `hey` under load and a malformed request the WAF blocks |
| [quiz.md](./quiz.md) | 14 questions, answer key at the bottom |
| [homework.md](./homework.md) | Six problems with rubric and time estimates |
| [mini-project/README.md](./mini-project/README.md) | Full spec for the multi-backend global edge **and** the Phase 1+2 midterm architecture review |
