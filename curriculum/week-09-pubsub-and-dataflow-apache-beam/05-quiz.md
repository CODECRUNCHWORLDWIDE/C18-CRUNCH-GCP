...
If you scored under 9, re-read the lectures for the questions you missed — especially Q7/Q8/Q9 (the watermark/lateness/accumulation triad) and Q3/Q4 (DLQ IAM and exactly-once caveats), which are the ones engineers get wrong in production. If you scored 11 or 12, you're ready for the [homework](./06-homework.md).
