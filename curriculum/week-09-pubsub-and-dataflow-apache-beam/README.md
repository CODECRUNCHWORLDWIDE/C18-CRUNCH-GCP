...
| [resources.md](./resources.md) | Curated GCP docs, Beam docs, and the comparison sources, current to 2026 |
| [lecture-notes/01-pubsub-vs-kafka-nats-sqs.md](./lecture-notes/01-pubsub-vs-kafka-nats-sqs.md) | The Pub/Sub data model end-to-end, then the four-way comparison: when each broker wins |
| [lecture-notes/02-watermarks-late-data-and-triggers.md](./lecture-notes/02-watermarks-late-data-and-triggers.md) | Windows, watermarks, triggers, and the six-months-of-wrong-numbers war story |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-ordering-key-and-dlq.md](./exercises/exercise-01-ordering-key-and-dlq.md) | Terraform a topic with an ordering key + DLQ; prove malformed messages land in the DLQ |
| [exercises/exercise-02-beam-windowing.py](./exercises/exercise-02-beam-windowing.py) | A runnable Beam pipeline with fixed and sliding windows on the Direct runner |
| [exercises/exercise-03-push-vs-pull-decision.py](./exercises/exercise-03-push-vs-pull-decision.py) | A runnable decision tool + a working push and pull consumer for two stated patterns |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-kill-the-workers.md](./challenges/challenge-01-kill-the-workers.md) | Build the full streaming pipeline, kill workers mid-stream, prove exactly-once and no data loss |
...
| [mini-project/README.md](./mini-project/README.md) | Full spec for the deployable streaming-ingest mini-project |
