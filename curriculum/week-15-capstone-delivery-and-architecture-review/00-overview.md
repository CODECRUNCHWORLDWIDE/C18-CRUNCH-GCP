...
| [resources.md](./01-resources.md) | Architecture-review references, exam blueprints, load/chaos tooling, exit-plan templates |
| [lecture-notes/01-how-a-real-architecture-review-runs.md](./02-lecture-notes/01-how-a-real-architecture-review-runs.md) | The agenda, the artifacts, and the questions a staff engineer will ask |
| [lecture-notes/02-the-exit-plan-defending-the-cost-of-leaving-gcp.md](./02-lecture-notes/02-the-exit-plan-defending-the-cost-of-leaving-gcp.md) | Pricing the lock-in: every managed dependency, its replacement, and the engineer-weeks |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-load-test-100rps-p99.md](./03-exercises/exercise-01-load-test-100rps-p99.md) | Run 100 RPS for 30 minutes and verify p99 < 500ms end-to-end |
| [exercises/exercise-02-chaos-drill.py](./03-exercises/exercise-02-chaos-drill.py) | Drive and verify one chaos drill, capture the timeline, write the result |
| [exercises/exercise-03-pca-readiness-gate.py](./03-exercises/exercise-03-pca-readiness-gate.py) | Score the PCA / Cloud DevOps practice exam against the >=70% gate |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-deliver-the-capstone-live.md](./04-challenges/challenge-01-deliver-the-capstone-live.md) | Deliver the Realtime Event Pipeline at Scale live, end to end |
| [quiz.md](./05-quiz.md) | 13 questions, answer key at the bottom |
| [homework.md](./06-homework.md) | The week's deliverables with a rubric |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The full capstone integration brief |
