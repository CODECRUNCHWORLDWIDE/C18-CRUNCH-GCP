...
If you scored under 9, re-read the lecture for the questions you missed — especially Q5 (budget ≠ cap) and Q1 (project ≠ account), which are the two ideas the whole week turns on. If you scored 12 or 13, you're ready for the [homework](./06-homework.md).
