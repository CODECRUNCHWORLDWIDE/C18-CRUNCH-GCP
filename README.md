...
- [week 01 gcp resource hierarchy and billing discipline](curriculum/week-01-gcp-resource-hierarchy-and-billing-discipline/README.md)
- [week 02 iam service accounts and workload identity](curriculum/week-02-iam-service-accounts-and-workload-identity/README.md)
- [week 03 vpc subnets routes and cloud nat](curriculum/week-03-vpc-subnets-routes-and-cloud-nat/README.md)
- [week 04 terraform for gcp end to end](curriculum/week-04-terraform-for-gcp-end-to-end/README.md)
- [week 05 compute engine instance groups and managed vms](curriculum/week-05-compute-engine-instance-groups-and-managed-vms/README.md)
- [week 06 gke autopilot vs standard](curriculum/week-06-gke-autopilot-vs-standard/README.md)
- [week 07 cloud run cloud functions and the serverless decision](curriculum/week-07-cloud-run-cloud-functions-and-the-serverless-decision/README.md)
- [week 08 cloud load balancing and cloud armor](curriculum/week-08-cloud-load-balancing-and-cloud-armor/README.md)
- [week 09 pubsub and dataflow apache beam](curriculum/week-09-pubsub-and-dataflow-apache-beam/README.md)
- [week 10 bigquery deep](curriculum/week-10-bigquery-deep/README.md)
- [week 11 spanner cloud sql alloydb and the database decision](curriculum/week-11-spanner-cloud-sql-alloydb-and-the-database-decision/README.md)
- [week 12 vertex ai model garden and serving inference](curriculum/week-12-vertex-ai-model-garden-and-serving-inference/README.md)
- [week 13 observability with opentelemetry](curriculum/week-13-observability-with-opentelemetry/README.md)
- [week 14 security hardening finops and the on call drill](curriculum/week-14-security-hardening-finops-and-the-on-call-drill/README.md)
- [week 15 capstone delivery and architecture review](curriculum/week-15-capstone-delivery-and-architecture-review/README.md)
